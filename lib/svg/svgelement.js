var html = Object.create(require("jsdom").level(3, "html"));
var core = Object.create(require("jsdom").level(3, "core"));
...
function define(elementClass, def) {
  ...
  tagNames.forEach(function(tag) {
    core.Document.prototype._elementBuildersNS[namespace][tag.toLowerCase()] = function(doc, s) {
