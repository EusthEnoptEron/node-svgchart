...
function NodeChart() {
	...
	this.clean = function() {
		if(window) {
			window.document.body.childNodes.forEach(function(node) {
			...
			jsdom.env({
				...
				html: '<html><body><div id="chart"></div></body></html>',
					...
					w.HTMLElement.prototype.__defineGetter__("offsetWidth", function() {
						return this.getAttribute("offsetWidth") || this.width || this.style.width;
					});
					w.HTMLElement.prototype.__defineSetter__("offsetWidth", function(width) {
						this.setAttribute("offsetWidth", width);
					});
					w.HTMLElement.prototype.__defineGetter__("offsetHeight", function() {
						return this.getAttribute("offsetHeight") || this.height || this.style.height;
					});
					w.HTMLElement.prototype.__defineSetter__("offsetHeight", function(height) {
