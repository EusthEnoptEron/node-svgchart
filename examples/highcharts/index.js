...
.setup(function(e, callback) {
        var colors = this.Highcharts.getOptions().colors,
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            for (var j = 0; j < data[i].drilldown.data.length; j++) {
                ...
                versionsData.push({
                    ...
                    color: this.Highcharts.Color(data[i].color).brighten(brightness).get()
                });
            }
        }
